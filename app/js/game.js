	...
	this.waves = function(map, lvl){
		...
		switch(map){
			...
			switch(lvl){
				...
				break;
				case 1:
					V.spawn.push('orc', 1, 4, 40);
				break;
				case 2:
					V.spawn.push('orc', 1, 5, 40);
				break;
				case 3:
					V.spawn.push('orc', 1, 10, 35);
					V.spawn.push('orc', 2, 1, 60);		
				break;
				case 4:
					V.spawn.push('man', 1, 5, 50);
				break;
				case 5:
					V.spawn.push('orc', 2, 10, 45);
					V.spawn.push('man', 1, 5, 55);
				break;
				case 6:
					V.spawn.push('man', 1, 5, 45);
					V.spawn.push('orc', 1, 25, 35);
				break;
				case 7:
					V.spawn.push('orc', 3, 25, 40);
				break;
				case 8:
					V.spawn.push('man', 2, 10, 40);
					V.spawn.push('orc', 4, 20, 35);
				break;
				case 9:
					V.spawn.push('orc', 5, 25, 25);
					V.spawn.push('man', 3, 10, 50);
					V.spawn.push('man', 2, 20, 45);
				break;
				case 10:
					V.spawn.push('worm', 5, 2, 50);
				break;
				case 11:
					this.animWin();
			...
			switch(lvl){
				...
				case 14:
					...
					V.spawn.push('man', 7, 12, 40);
					V.spawn.push('worm', 6, 8, 40);
				break;
				case 15:
					V.spawn.push('man', 12, 4, 100);
					V.spawn.push('worm', 9, 2, 80);	
					V.spawn.push('dragon', 6, 1, 150);	
				break;
				case 16:
					this.animWin();
			...
			switch(lvl){
				...
				break;
				case 1:
					V.spawn.push('orc', 2, 30, 40);
				break;
				case 2:
					V.spawn.push('orc', 3, 20, 40);
					V.spawn.push('dragon', 1, 8, 55);
				break;
				case 3:
					V.spawn.push('zombie', 1, 2, 55);
					V.spawn.push('orc', 2, 20, 35);
				break;
				case 4:
					V.spawn.push('worm', 1, 10, 25);
					V.spawn.push('man', 2, 20, 40);
					V.spawn.push('dragon', 2, 4, 50);
				break;
				case 5:
					V.spawn.push('orc', 4, 40, 35);
				break;
				case 6:
					V.spawn.push('zombie', 2, 2, 45);
					V.spawn.push('dragon', 2, 10, 50);
					V.score+=250;
				break;
				case 7:
					V.spawn.push('zombie', 3, 4, 45);
					V.spawn.push('worm', 4, 15, 40);
					V.spawn.push('dragon', 3, 10, 55);
				break;
				case 8:
					V.spawn.push('man', 6, 20, 45);
					V.spawn.push('zombie', 4, 10, 55);
					V.score+=250;
				break;
				case 9:
					V.spawn.push('orc', 12, 30, 25);
					V.spawn.push('dragon', 6, 15, 45);
				break;
				case 10:
					V.spawn.push('worm', 10, 30, 35);
					V.spawn.push('zombie', 6, 10, 45);
					V.spawn.push('dragon', 6, 15, 25);
					V.score+=250;
				break;
				case 11:
					V.spawn.push('zombie', 10, 20, 65);
				break;
				case 12:
					V.spawn.push('knight', 12, 4, 150);
				break;
				case 13:
					this.animWin();
			...
			switch(lvl){
				...
				break;
				case 1:
					V.spawn.push('orc', 1, 30, 25);
					V.spawn.push('orc', 5, 5, 55);
				break;
				case 2:
					V.spawn.push('man', 1, 25, 30);
					V.spawn.push('man', 5, 5, 60);
					V.score+=100;
				break;
				case 3:
					V.spawn.push('worm', 1, 20, 35);
					V.spawn.push('worm', 5, 5, 65);
					V.score+=100;
				break;
				case 4:
					V.spawn.push('dragon', 1, 15, 45);
					V.spawn.push('dragon', 5, 5, 70);
					V.score+=100;
				break;
				case 5:
					V.spawn.push('zombie', 1, 10, 45);
					V.spawn.push('zombie', 5, 5, 75);
					V.score+=100;
				break;
				case 6:
					V.spawn.push('knight', 1, 10, 50);
					V.spawn.push('knight', 5, 5, 80);
					V.score+=100;
				break;
				case 7:
					V.spawn.push('zombie', 2, 15, 45);
					V.spawn.push('dragon', 3, 15, 50);
					V.score+=100;
				break;
				case 8:
					V.spawn.push('knight', 5, 10, 60);
					V.score+=100;
				break;
				case 9:
					V.spawn.push('orc', 10, 25, 35);
					V.spawn.push('man', 10, 15, 40);
					V.spawn.push('worm', 10, 10, 45);
					V.score+=100;
				break;
				case 10:
					V.spawn.push('orc', 20, 5, 35);
					V.spawn.push('man', 15, 5, 40);
					V.spawn.push('worm', 12, 5, 45);
					V.spawn.push('dragon', 10, 5, 45);
					V.spawn.push('zombie', 8, 5, 45);
					V.spawn.push('knight', 6, 5, 45);
					V.score+=500;
				break;
				case 7:
					this.animWin();
